...
const LLM_RATES: Record<string, LlmRate> = {
  ...
  'gpt-5.6-luna-fast': { input: all(0.4), cached: all(0.04), output: all(2.4) },
...
const TTS_ALIASES: Record<string, string> = {
  ...
  'fishaudio/s2-pro': 'fish-s2-pro',
  'fishaudio/s2.1-pro': 'fish-s2.1-pro',
  'fishaudio/s2.1-pro-free': 'fish-s2.1-pro-free',
  'fish-audio/s2.1-pro-free': 'fish-s2.1-pro-free',
  'fish-audio/s2.1-pro-free:free': 'fish-s2.1-pro-free',
  'fish-s2.1-pro-free': 'fish-s2.1-pro-free',
  'rime/coda': 'rime-coda',
  'rime/mist': 'rime-mist',
