...
const BASE_DESCRIPTION = [
  ...
  '',
  'WHEN TO USE:',
  '- Before scheduleGhlMeeting when lookup_ghl_contact returned found=false or lookup is not available.',
  ...
  '- Prefer lookup_ghl_contact first if that tool is enabled, so you do not duplicate an existing lead.',
  '',
  'WHEN NOT TO USE:',
