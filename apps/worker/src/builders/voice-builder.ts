 ...
 * fragments sat on the 2.5s ceiling (prod gap ~2363ms). Step 2 uses
 * 200 / 400 so confident turns commit sooner and fragments stay under
 * half a second. Do not raise minDelay for the
...
export function buildAgentSession(
  ...
  // only for STT-owned turns. Override streaming 300/2500 with 200/400 and
