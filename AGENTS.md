...
| `SARVAM_API_KEY` | worker | Optional. Required when an agent uses Sarvam plugin models (`sarvam/saaras-v3` STT or `sarvam/bulbul-v3` TTS). Never in LiveKit metadata or Vite. Missing key **fails** those jobs. |
