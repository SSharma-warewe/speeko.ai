...
| Web (marketing) | `apps/web` | Public marketing Vite + React SPA (`/`, `/get-demo`, `/how-it-works`, `/solutions`, `/solutions/customer-service`, `/solutions/marketing-sales`) |
